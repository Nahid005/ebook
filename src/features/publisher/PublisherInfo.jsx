...
function PublisherInfo({publisheInfo}) {
    const {
        name, 
        image, 
        since_year,
    ...
    const publisherDescription = DOMPurify.sanitize(description || "");
        ...
        <div className="flex flex-col md:flex-row md:justify-start justify-center items-start gap-4 my-4 border-b border-b-neutral-200 pb-3">
            ...
            <div className="flex flex-col justify-start items-start gap-1">
                ...
                <p 
                    ...
                    dangerouslySetInnerHTML={{ __html: publisherDescription?.slice(0, 500) }}
                />
            </div>
        </div>
    )

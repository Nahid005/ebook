...
function Header() {
    ...
    return (
        <div className={` w-full h-[8ch] backdrop-blur-sm fixed md:static top-0 ${isScrolled ? 'bg-sky-50/30 border-b border-neutral-200': 'bg-orange-100'} flex justify-center text-center`}>
            
            <div className={` w-full h-[8ch] backdrop-blur-sm flex items-center justify-between px-4 md:px-0 fixed top-0 transition-all ease-in-out duration-300 z-50 max-w-[1400px] mx-auto`}>
                ...
                <div className={`fixed md:static top-0 right-0 h-screen md:h-auto w-full md:w-auto bg-sky-50 border-1 md:border-none border-neutral-300 md:bg-transparent shadow-lg md:shadow-none  ease-in-out duration-300 transition-transform md:translate-x-0 flex-1 ${open ? 'translate-x-0' : 'translate-x-full'} z-60`}>
